...
import com.example.newstaskapp.databinding.FragmentFavBinding
...
class FavFragment : Fragment() {
    ...
    private fun setData(newsData : NewsData) {
        ...
        viewBinding.rvNews.layoutManager = LinearLayoutManager(activity!!,
    ...
    private fun initViewModel() {
        newsViewModel = ViewModelProvider(this, NewsModelFactory(NewsRepository(apiResponse))).get(NewsViewModel::class.java)
